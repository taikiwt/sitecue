	...
	return (
		<div className="flex flex-col gap-3 rounded-xl border border-base-border bg-base-surface p-4 shadow-sm">
			<div className="flex items-center justify-between">
				<div className="flex items-center gap-1.5 rounded-full bg-base-bg p-1">
					<FilterBadge
						isActive={noteType === "info"}
						onClick={() => setNoteType("info")}
						className={cn(
							"px-2.5 py-1 text-[10px] uppercase tracking-wider",
							noteType === "info"
								? "bg-base-surface text-note-info hover-safe:text-note-info hover-safe:bg-base-surface"
					...
					<FilterBadge
						isActive={noteType === "alert"}
						onClick={() => setNoteType("alert")}
						className={cn(
							"px-2.5 py-1 text-[10px] uppercase tracking-wider",
							noteType === "alert"
								? "bg-base-surface text-note-alert hover-safe:text-note-alert hover-safe:bg-base-surface"
					...
					<FilterBadge
						isActive={noteType === "idea"}
						onClick={() => setNoteType("idea")}
						className={cn(
							"px-2.5 py-1 text-[10px] uppercase tracking-wider",
							noteType === "idea"
								? "bg-base-surface text-note-idea hover-safe:text-note-idea hover-safe:bg-base-surface"
