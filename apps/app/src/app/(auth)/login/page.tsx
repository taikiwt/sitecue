...
import { ForceDashboardRedirect } from "./_components/ForceDashboardRedirect";
				...
				<div className="mt-8">
					<form action={handleLogin} className="grid gap-4">
						<Button
							...
							value="google"
							variant="outline"
							className="w-full h-12 rounded-xl gap-3 text-sm font-semibold border-base-border hover:bg-base-surface transition-colors cursor-pointer"
						>
							<svg
								className="h-5 w-5"
								viewBox="0 0 24 24"
						...
						<Button
							...
							name="provider"
							value="github"
							className="w-full h-12 rounded-xl gap-3 bg-[#24292F] text-white hover:bg-[#24292F]/90 text-sm font-semibold cursor-pointer"
						>
							<svg
								width="20"
								height="20"
