			...
			<div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
				<form action={handleLogin} className="grid gap-4">
					<button
						...
						name="provider"
						value="google"
						className="flex w-full justify-center items-center gap-3 rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm font-semibold text-neutral-900 shadow-sm hover:bg-neutral-50 cursor-pointer transition-all active:scale-[0.98]"
					>
						<svg
							className="h-5 w-5"
							viewBox="0 0 24 24"
					...
					<button
						...
						name="provider"
						value="github"
						className="cursor-pointer w-full flex items-center justify-center gap-3 bg-[#24292F] text-white py-3 rounded-xl text-sm font-semibold hover:bg-[#24292F]/90 transition-all active:scale-[0.98]"
					>
						<svg
							width="20"
							height="20"
