			...
			<div className="w-full max-w-xs bg-base-surface p-6 rounded-lg shadow-md border border-base-border">
				...
				<div className="space-y-3">
					<button
						...
						className="cursor-pointer w-full flex items-center justify-center gap-2 bg-base-bg border border-base-border text-action py-2.5 rounded-full text-sm font-medium hover:bg-base-surface transition-colors disabled:opacity-50"
					>
						{/* Google Icon (SVG) */}
					...
					<button
						...
						disabled={authLoading}
						className="cursor-pointer w-full flex items-center justify-center gap-2 bg-base-bg text-action py-2.5 border border-base-border rounded-full text-sm font-medium hover:bg-base-surface transition-colors disabled:opacity-50"
					>
				...
				<div className="mt-5 pt-4 border-t border-base-border/60 space-y-2.5">
					...
					<button
						...
						className="cursor-pointer w-full py-2.5 rounded-full bg-base-bg border border-base-border text-action hover:bg-base-surface transition-colors text-sm font-medium text-center block"
					>
